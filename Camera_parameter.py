...
images = glob.glob('Ressources/Checkboard/*.jpg')
...
with open("Output/cam_parameters.npz", "wb") as f: np.savez(f, mtx=mtx, dist=dist, rvecs=rvecs, tvecs=tvecs)
...
x, y, w, h = roi
dst = dst[y:y+h, x:x+w]
cv.imwrite('Output/etallonage.jpg', dst)
